namespace Fizzler.Systems.HtmlAgilityPack
{
    ...
    {
        private static IDictionary<string, HtmlElementFlag> _defaultElementFlags;
        ...
        */
        ...
        public static void LoadHtmlWithElementFlags(this HtmlDocument document, string html, IDictionary<string, HtmlElementFlag> flags)
        {
            if (document == null) throw new ArgumentNullException("document");
        ...
        //[MethodImpl(MethodImplOptions.Synchronized)]
        /*public static void LoadWithElementFlags(this HtmlDocument document, string path, IDictionary<string, HtmlElementFlag> flags)
        {
            if (document == null) throw new ArgumentNullException("document");
        ...
        */
        ...
        private static void LoadWithElementFlags(IDictionary<string, HtmlElementFlag> flags, LoadHandler loader)
        {
        ...
        private static IDictionary<string, HtmlElementFlag> DefaultElementFlags
        {
            get
            {
