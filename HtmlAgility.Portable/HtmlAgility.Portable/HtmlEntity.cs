...
namespace HtmlAgilityPack
{
    ...
    public class HtmlEntity
    {
        ...
        private static IDictionary<int, string> _entityName = new Dictionary<int, string>();
        private static IDictionary<string, int> _entityValue = new Dictionary<string, int>();

        /// <summary>
        /// A collection of entities indexed by name.
        /// </summary>
        public static IDictionary<int, string> EntityName
        {
        ...
        /// </summary>
        public static IDictionary<string, int> EntityValue
        {
