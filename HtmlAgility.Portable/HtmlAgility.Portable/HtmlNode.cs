...
namespace HtmlAgilityPack
{
    ...
    public class HtmlNode
    {
        ...
        /// </summary>
        public static IDictionary<string, HtmlElementFlag> ElementsFlags = new Dictionary<string, HtmlElementFlag>();
        ...
        public static bool CanOverlapElement(string name)
        {
            ...
            {
                return (ElementsFlags[name] & HtmlElementFlag.CanOverlap) != 0;
            }
            else
            {
                return false;
        ...
        public static bool IsCDataElement(string name)
        {
            ...
            if (ElementsFlags.ContainsKey(name))
            {
                return (ElementsFlags[name] & HtmlElementFlag.CData) != 0;
            }
            else
            {
                return false;
        ...
        public static bool IsClosedElement(string name)
        {
            ...
            if (ElementsFlags.ContainsKey(name))
            {
                return (ElementsFlags[name] & HtmlElementFlag.Closed) != 0;
            }
            else
            {
                return false;
        ...
        public static bool IsEmptyElement(string name)
        {
            ...
            if (ElementsFlags.ContainsKey(name))
            {
                return (ElementsFlags[name] & HtmlElementFlag.Empty) != 0;
            }
            else
            {
                return false;
        ...
        internal void CloseNode(HtmlNode endnode)
        {
            ...
            if (!Closed)
            {
                ...
                HtmlNode self = null;
                if(_ownerdocument._lastnodes.ContainsKey(Name))
                    self = _ownerdocument._lastnodes[Name];
                if (self == this)
                {
